...
import pl.edu.agh.iisg.map.tile.storage.TileStorageStrategy;
...
public class OpenStreetMapDriver implements IMapDriver {
     ...
     * {@inheritDoc}
     *
     * @see pl.edu.agh.iisg.map.tile.driver.editor.driver.IMapDriver#getTileDimension()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see pl.edu.agh.iisg.map.tile.driver.editor.driver.IMapDriver#getXRange(int)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see pl.edu.agh.iisg.map.tile.driver.editor.driver.IMapDriver#getYRange(int)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see pl.edu.agh.iisg.map.tile.driver.editor.driver.IMapDriver#getMaxZoomLevel()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see pl.edu.agh.iisg.map.tile.driver.editor.driver.IMapDriver#getMinZoomLevel()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see pl.edu.agh.iisg.map.tile.driver.editor.driver.IMapDriver#getTileStorageStrategy()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see pl.edu.agh.iisg.map.tile.driver.editor.driver.IMapDriver#getNoTile()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see pl.edu.agh.iisg.map.tile.driver.editor.driver.IMapDriver#getLoadTile()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see pl.edu.agh.iisg.map.tile.driver.editor.driver.IMapDriver#getDefaultZoomLevel()
     */
    @Override
