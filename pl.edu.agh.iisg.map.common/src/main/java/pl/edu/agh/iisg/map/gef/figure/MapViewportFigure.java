...
public class MapViewportFigure extends Figure implements IMapViewportFigure, IAsynchronousTileResultListener {
     ...
     * {@inheritDoc}
     *
     * @see pl.edu.agh.iisg.map.gef.figure.editor.figure.IMapViewportFigure#setPosition(double, double)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see pl.edu.agh.iisg.map.gef.figure.editor.figure.IMapViewportFigure#setMapManager(pl.edu.agh.iisg.map.tile.manager.editor.manager.IMapManager)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see pl.edu.agh.iisg.map.gef.figure.editor.figure.IMapViewportFigure#setLongitude(double)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see pl.edu.agh.iisg.map.gef.figure.editor.figure.IMapViewportFigure#setLatitude(double)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see pl.edu.agh.iisg.map.gef.figure.editor.figure.IMapViewportFigure#setZoomLevel(int)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see pl.edu.agh.iisg.map.gef.figure.editor.figure.IMapViewportFigure#setPositionAndZoomLevel(double, double, int)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see pl.edu.agh.iisg.map.gef.figure.editor.figure.IMapViewportFigure#getTopLeftX()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see pl.edu.agh.iisg.map.gef.figure.editor.figure.IMapViewportFigure#getTopLeftY()
     */
    @Override
...
//    	, ApplicationUtil.LOGGER_EXCEPTION_HANDLER);
     ...
     * {@inheritDoc}
     *
     * @see pl.edu.agh.iisg.map.gef.figure.editor.figure.IMapViewportFigure#getMiddlePoint()
     */
    @Override
