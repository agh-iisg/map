...
public class OpenStreetMapInternetProvider extends AbstractInternetMapProvider {
     ...
     * {@inheritDoc}
     *
     * @see pl.edu.agh.iisg.map.tile.provider.editor.provider.AbstractInternetMapProvider#getTileURL(int, int, int)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see pl.edu.agh.iisg.map.tile.provider.editor.provider.AbstractMapProvider#getDescription()
     */
    @Override
