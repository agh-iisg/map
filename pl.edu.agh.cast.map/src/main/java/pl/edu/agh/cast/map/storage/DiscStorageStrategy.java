...
public class DiscStorageStrategy implements IDiscStorageStrategy {
     ...
     * {@inheritDoc}
     * 
     * @see pl.edu.agh.cast.map.editor.storage.IDiscStorageStrategy#getPathToRoot()
     */
    @Override
     ...
     * {@inheritDoc}
     * 
     * @see pl.edu.agh.cast.map.editor.storage.IDiscStorageStrategy#getPathToTile(int, int, int)
     */
    @Override
