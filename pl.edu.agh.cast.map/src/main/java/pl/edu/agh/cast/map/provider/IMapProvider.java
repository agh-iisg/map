 ...
 * or provides only one type of map. Connection between {@link pl.edu.agh.cast.map.editor.manager.IMapProvider IMapProvider} and
 * {@link pl.edu.agh.cast.map.editor.driver.IMapDriver} is done via extension points. <b>IMPORTANT:</b> Map provider needs to have public
...
public interface IMapProvider extends IDisposable {
     ...
     * <b>NOT</b> be invoked in new thread even if can last long. {@link pl.edu.agh.cast.map.editor.manager.IMapManager IMapManager} is
