...
public class OpenSampleMapHandler {
	...
	private static final String EDITOR_ID = "pl.edu.agh.iisg.map.e4.partdescriptor.editor";
	
	private static final String STACK_ID = "pl.edu.agh.iisg.map.e4.partstack";
